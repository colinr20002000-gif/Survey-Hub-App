-- Add SHOW_EQUIPMENT_ASSIGNMENTS_MANAGE_BUTTON permission
-- This controls the visibility of the "Manage" button on the Equipment Assignments page
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'privilege_permissions') THEN
        FOREACH priv_level IN ARRAY priv_levels LOOP
            ...
            VALUES (
                priv_level, 
                'SHOW_EQUIPMENT_ASSIGNMENTS_MANAGE_BUTTON', 
                'Show Manage Button', 
