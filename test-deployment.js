// Test script to verify both Edge Functions are deployed and working
...
async function testBothFunctions() {
  ...
  console.log('1️⃣ Testing subscribe function...');
  try {
  ...
  console.log('2️⃣ Testing send-notification function...');
  try {
  ...
  console.log('\n🎯 Test complete! Deploy the functions if you see 404 errors.');
}
