...
export const leaveColors = {
    'Annual Leave': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
    'Bank Holiday': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
    'Office (Haydock)': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
    'Office (Home)': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
    'Training': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
    'Stand Down': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
    'Sick Day': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
    'Rest Day': 'bg-purple-100 text-purple-900 dark:bg-purple-800 dark:text-purple-50',
};
