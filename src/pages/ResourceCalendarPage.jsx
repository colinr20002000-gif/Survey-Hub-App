            ...
            return (
                ...
                >
                    ...
                    {hasComment && (() => {
                        ...
                        return (
                            <div 
                                className={`text-center text-sm font-semibold leading-tight line-clamp-3 px-1 py-0.5 mx-auto ${isHighlighted ? 'mt-1 text-red-600 dark:text-red-400 bg-white dark:bg-gray-800 rounded shadow-sm border border-red-200 dark:border-red-900/50' : ''}`}
                            >
                                {text}
                            </div>
                        );
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                ...
                <div className="flex items-center gap-2 flex-wrap justify-center">
                    ...
                    <div className="relative" ref={datePickerRef}>
                        ...
                        {isDatePickerOpen && (
                            <div className="fixed md:absolute left-auto right-4 md:left-1/2 md:right-auto md:-translate-x-1/2 top-auto md:top-full mt-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg p-4 z-50" style={{ minWidth: '280px', top: isDesktop ? undefined : `${datePickerRef.current?.getBoundingClientRect().bottom + 8}px` }}>
                                                                                                    ...
                                                                                                    >
                                                                                                        ...
                                                                                                        >
                                                                                                            ...
                                                                                                            {hasComment && (() => {
                                                                                                                ...
                                                                                                                return (
                                                                                                                    <div 
                                                                                                                        className={`text-center text-xs font-semibold leading-tight line-clamp-2 px-1 py-0.5 mx-auto ${isHighlighted ? 'mt-0.5 text-red-600 dark:text-red-400 bg-white dark:bg-gray-800 rounded shadow-sm border border-red-200 dark:border-red-900/50' : ''}`} 
                                                                                                                        title={text}
                                                                                                                    >
                                                                                                                        {text}
                                                                                                                    </div>
                                                                                        ...
                                                                                        >
                                                                                            ...
                                                                                            {assignment.time && <p className="text-xs leading-tight font-semibold truncate mb-0.5 text-center">{assignment.time}</p>}
                                                                                                                                                                                        {hasComment && (() => {
                                                                                                                                                                                            ...
                                                                                                                                                                                            return (
                                                                                                                                                                                                <div 
                                                                                                                                                                                                    className={`text-center text-sm font-semibold leading-tight line-clamp-3 mx-auto ${isHighlighted ? 'mt-1 px-1 py-0.5 text-red-600 dark:text-red-400 bg-white dark:bg-gray-800 rounded shadow-sm border border-red-200 dark:border-red-900/50' : ''}`} 
                                                                                                                                                                                                    title={text}
                                                                                                                                                                                                >
                                                                                                                                                                                                    {text}
                                                                                                                                                                                                </div>
                                                                                ...
                                                                                cellContent = (
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        >
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        {assignment.projectName && <p className="text-lg mb-0.5 font-bold leading-tight line-clamp-2" title={assignment.projectName}>{assignment.projectName}</p>}
                                                                                                                                                                                                                        {assignment.client && <p className="text-sm mb-0.5 leading-tight line-clamp-1" title={assignment.client}>{assignment.client}</p>}
                                                                                                                                                                                                                        {assignment.task && <p className="text-sm mb-0.5 font-semibold truncate">{assignment.task}</p>}
                                                                                                                                                                                                                        {assignment.shift && <p className="text-sm mb-0.5 font-semibold truncate">{assignment.shift}</p>}
                                                                                                                                                                                                                        {assignment.time && <p className="text-sm mb-0.5 font-semibold truncate">{assignment.time}</p>}
                                                                                                                                                                                                                        {assignment.comment && (() => {
                                                                                                                                                                                                                            const { text, isHighlighted } = getCommentDisplay(assignment.comment);
                                                                                                                                                                                                                            return (
                                                                                                                                                                                                                                <p 
                                                                                                                                                                                                                                    className={`text-sm font-semibold leading-tight line-clamp-2 mx-auto w-fit max-w-full ${isHighlighted ? 'mt-0.5 px-1 py-0.5 text-red-600 dark:text-red-400 bg-white dark:bg-gray-800 rounded shadow-sm border border-red-200 dark:border-red-900/50' : ''}`} 
                                                                                                                                                                                                                                    title={text}
                                                                                                                                                                                                                                >
                                                                                                                                                                                                                                    {text}
                                                                                                                                                                                                                                </p>
