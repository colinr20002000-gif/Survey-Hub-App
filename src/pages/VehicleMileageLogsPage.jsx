...
import InspectionDetailModal from '../components/Vehicles/InspectionDetailModal';
                        ...
                        {hasPermission(user?.privilege, 'EXPORT_VEHICLE_INSPECTIONS') && (
                            <>
                                <Button
                                    ...
                                    variant="outline"
                                    className="flex items-center space-x-2 border-orange-200 dark:border-orange-800 text-orange-600 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20"
                                >
                                    <Wand2 className="w-4 h-4" />
                                    <span className="hidden sm:inline">Export Wizard</span>
                                </Button>
                                <Button
