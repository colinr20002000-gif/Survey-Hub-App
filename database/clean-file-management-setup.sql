-- Clean File Management System Setup for Supabase
-- This script drops existing objects and recreates them properly
...
-- 5. Remove storage bucket (this might fail if bucket has files - that's OK)
...
-- 7. Create table for file metadata and organization
...
-- 8. Create table for folder structure
...
-- 11. Create RLS policies for document_files table
...
-- 12. Create RLS policies for document_folders table
