...
CREATE POLICY "admins_view_audit_logs" ON audit_logs FOR SELECT USING (true);
CREATE POLICY "system_insert_audit_logs" ON audit_logs FOR INSERT WITH CHECK (true);
...
INSERT INTO audit_logs (user_id, action, entity, entity_id, timestamp, details) VALUES
    (1, 'LOGIN', 'USER', 1, '2024-08-25 10:30:15+01:00', '{}'),
    (2, 'CREATE', 'PROJECT', 7, '2024-08-25 09:15:45+01:00', '{}'),
    (1, 'UPDATE', 'USER', 3, '2024-08-25 08:45:22+01:00', '{}'),
    (3, 'DELETE', 'TASK', 5, '2024-08-24 15:50:00+01:00', '{}'),
    (2, 'LOGOUT', 'USER', 2, '2024-08-24 12:30:00+01:00', '{}'),
    (null, 'SYSTEM_EVENT', 'SYSTEM', null, '2024-08-24 11:00:00+01:00', '{}'),
